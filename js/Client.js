...
(function(Global)
{
 ...
 Node=Global.Node;
 Highlight=Website.Highlight=Website.Highlight||{};
 ...
 Date=Global.Date;
 Client.ToggleDrawer=function()
 {
  Client.DrawerShown().Update(function(v)
  {
   return!v;
  });
 };
 Client.Main=function()
 {
  ...
  },Client.DrawerShown().get_View());
  Highlight.Run();
 };
 Client.DrawerShown=function()
 {
  SC$1.$cctor();
